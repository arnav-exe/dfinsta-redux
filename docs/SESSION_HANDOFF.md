...
1. Run a fresh approved 340-only real build retry and validate its exact `ReplayPatchedApkReceiptV1`, composition, and adoption evidence. Run 430 only after 340 succeeds.
