...
.method public static checkVersion(Landroid/app/Activity;)V
    ...
    const-string v2, "to_settings"

    invoke-static {v2}, Lcom/dfinstagram/dfinstagram;->getInstanderString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    new-instance v3, Lcom/dfinstagram/SettingsWrapper;

    invoke-direct {v3}, Lcom/dfinstagram/SettingsWrapper;-><init>()V

    invoke-virtual {v0, v2, v3}, Lcom/dfinstagram/dialog_maker;->setBlueButton(Ljava/lang/String;Landroid/content/DialogInterface$OnClickListener;)V
    ...
    invoke-static {p0, v3}, Lcom/dfinstagram/dfinstagram;->deleteCacheDirectory(Landroid/content/Context;Ljava/lang/String;)V
