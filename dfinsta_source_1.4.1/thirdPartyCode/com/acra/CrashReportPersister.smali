.class final Lcom/acra/CrashReportPersister;
...
.method constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/acra/CrashReportPersister;->context:Landroid/content/Context;
...
.method private declared-synchronized load(Ljava/io/Reader;)Lcom/acra/collector/CrashReportData;
    .locals 21
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    new-instance v5, Lcom/acra/collector/CrashReportData;

    invoke-direct {v5}, Lcom/acra/collector/CrashReportData;-><init>()V
    ...
    const-class v19, Lcom/acra/ReportField;
    ...
    invoke-virtual {v5, v0, v1}, Lcom/acra/collector/CrashReportData;->put(Ljava/lang/Enum;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    check-cast v9, Lcom/acra/ReportField;
    ...
    invoke-virtual {v5, v9, v0}, Lcom/acra/collector/CrashReportData;->put(Ljava/lang/Enum;Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_1
...
# virtual methods
.method public load(Ljava/lang/String;)Lcom/acra/collector/CrashReportData;
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    iget-object v3, p0, Lcom/acra/CrashReportPersister;->context:Landroid/content/Context;
    ...
    invoke-direct {p0, v0}, Lcom/acra/CrashReportPersister;->isEbcdic(Ljava/io/BufferedInputStream;)Z
    ...
    invoke-direct {p0, v3}, Lcom/acra/CrashReportPersister;->load(Ljava/io/Reader;)Lcom/acra/collector/CrashReportData;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public store(Lcom/acra/collector/CrashReportData;Ljava/lang/String;)V
    .locals 8
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    iget-object v6, p0, Lcom/acra/CrashReportPersister;->context:Landroid/content/Context;
    ...
    invoke-virtual {p1}, Lcom/acra/collector/CrashReportData;->entrySet()Ljava/util/Set;
    ...
    check-cast v6, Lcom/acra/ReportField;

    invoke-virtual {v6}, Lcom/acra/ReportField;->toString()Ljava/lang/String;

    move-result-object v3

    const/4 v6, 0x1

    invoke-direct {p0, v0, v3, v6}, Lcom/acra/CrashReportPersister;->dumpString(Ljava/lang/StringBuilder;Ljava/lang/String;Z)V
    ...
    invoke-direct {p0, v0, v6, v7}, Lcom/acra/CrashReportPersister;->dumpString(Ljava/lang/StringBuilder;Ljava/lang/String;Z)V
