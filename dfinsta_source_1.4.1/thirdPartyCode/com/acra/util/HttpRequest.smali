.class public final Lcom/acra/util/HttpRequest;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/acra/util/HttpRequest$1;,
        Lcom/acra/util/HttpRequest$SocketTimeOutRetryHandler;
    }
.end annotation
...
.method public constructor <init>()V
    ...
    iput v0, p0, Lcom/acra/util/HttpRequest;->connectionTimeOut:I

    iput v0, p0, Lcom/acra/util/HttpRequest;->socketTimeOut:I

    const/4 v0, 0x3

    iput v0, p0, Lcom/acra/util/HttpRequest;->maxNrRetries:I
...
.method private getCredentials()Lorg/apache/http/auth/UsernamePasswordCredentials;
    ...
    iget-object v0, p0, Lcom/acra/util/HttpRequest;->login:Ljava/lang/String;

    if-nez v0, :cond_0

    iget-object v0, p0, Lcom/acra/util/HttpRequest;->password:Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/acra/util/HttpRequest;->login:Ljava/lang/String;

    iget-object v2, p0, Lcom/acra/util/HttpRequest;->password:Ljava/lang/String;
...
.method private getHttpClient()Lorg/apache/http/client/HttpClient;
    ...
    iget v5, p0, Lcom/acra/util/HttpRequest;->connectionTimeOut:I
    ...
    iget v5, p0, Lcom/acra/util/HttpRequest;->socketTimeOut:I
    ...
    invoke-virtual {v5}, Lcom/acra/ACRAConfiguration;->disableSSLCertValidation()Z
    ...
    new-instance v7, Lcom/acra/util/FakeSocketFactory;

    invoke-direct {v7}, Lcom/acra/util/FakeSocketFactory;-><init>()V
    ...
    new-instance v4, Lcom/acra/util/HttpRequest$SocketTimeOutRetryHandler;

    iget v5, p0, Lcom/acra/util/HttpRequest;->maxNrRetries:I

    const/4 v6, 0x0

    invoke-direct {v4, v2, v5, v6}, Lcom/acra/util/HttpRequest$SocketTimeOutRetryHandler;-><init>(Lorg/apache/http/params/HttpParams;ILcom/acra/util/HttpRequest$1;)V
...
.method private getHttpRequest(Ljava/net/URL;Lcom/acra/sender/HttpSender$Method;Ljava/lang/String;Lcom/acra/sender/HttpSender$Type;)Lorg/apache/http/client/methods/HttpEntityEnclosingRequestBase;
    .locals 8
    ...
    sget-object v5, Lcom/acra/util/HttpRequest$1;->$SwitchMap$org$acra$sender$HttpSender$Method:[I

    invoke-virtual {p2}, Lcom/acra/sender/HttpSender$Method;->ordinal()I
    ...
    invoke-virtual {p2}, Lcom/acra/sender/HttpSender$Method;->name()Ljava/lang/String;
    ...
    :goto_0
    invoke-direct {p0}, Lcom/acra/util/HttpRequest;->getCredentials()Lorg/apache/http/auth/UsernamePasswordCredentials;
    ...
    invoke-virtual {p4}, Lcom/acra/sender/HttpSender$Type;->getContentType()Ljava/lang/String;

    move-result-object v6

    invoke-virtual {v3, v5, v6}, Lorg/apache/http/client/methods/HttpEntityEnclosingRequestBase;->setHeader(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v5, p0, Lcom/acra/util/HttpRequest;->headers:Ljava/util/Map;
...
# virtual methods
.method public send(Ljava/net/URL;Lcom/acra/sender/HttpSender$Method;Ljava/lang/String;Lcom/acra/sender/HttpSender$Type;)V
    .locals 9
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    invoke-direct {p0}, Lcom/acra/util/HttpRequest;->getHttpClient()Lorg/apache/http/client/HttpClient;

    move-result-object v0

    invoke-direct {p0, p1, p2, p3, p4}, Lcom/acra/util/HttpRequest;->getHttpRequest(Ljava/net/URL;Lcom/acra/sender/HttpSender$Method;Ljava/lang/String;Lcom/acra/sender/HttpSender$Type;)Lorg/apache/http/client/methods/HttpEntityEnclosingRequestBase;

    move-result-object v1

    sget-object v5, Lcom/acra/ACRA;->log:Lcom/acra/log/ACRALog;
    ...
    invoke-interface {v5, v6, v7}, Lcom/acra/log/ACRALog;->d(Ljava/lang/String;Ljava/lang/String;)I
...
.method public setConnectionTimeOut(I)V
    ...
    iput p1, p0, Lcom/acra/util/HttpRequest;->connectionTimeOut:I
...
.method public setHeaders(Ljava/util/Map;)V
    ...
    iput-object p1, p0, Lcom/acra/util/HttpRequest;->headers:Ljava/util/Map;
...
.method public setLogin(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcom/acra/util/HttpRequest;->login:Ljava/lang/String;
...
.method public setMaxNrRetries(I)V
    ...
    iput p1, p0, Lcom/acra/util/HttpRequest;->maxNrRetries:I
...
.method public setPassword(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcom/acra/util/HttpRequest;->password:Ljava/lang/String;
...
.method public setSocketTimeOut(I)V
    ...
    iput p1, p0, Lcom/acra/util/HttpRequest;->socketTimeOut:I
